...
// Source: scripts/mapgen/templates/tactical/patches/patch_tundra_brushes.nut
// Functions: 2
            ...
            else
            {
                if ((this.Math.abs((_rect.Y - ((_rect.Y + _rect.H) - 1)) <= 2) || (this.Math.abs((_rect.Y - ((_rect.Y + _rect.H) - 1))) <= 2) || (this.Math.abs((_rect.Y - ((_rect.Y + _rect.H) - 1))) <= 2)))
                {
                    ...
                    else
                    {
                        ...
                        if (this.Math.rand(0, 100) < 33)
                        {
                            if ((this.Math <= 18) && (this.Math <= 18))
                            {
                                return ((this.Math <= 18) && (this.Math <= 18));
                                this.Tactical.getTileSquare(_rect.X, _rect.Y).clear();
                                this.Tactical.getTileSquare(_rect.X, _rect.Y).spawnObject("entity/tactical/objects/tundra_brush");
                            }
                            return;
                        }
                    }
