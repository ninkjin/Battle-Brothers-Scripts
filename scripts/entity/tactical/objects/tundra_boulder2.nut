...
// Source: scripts/entity/tactical/objects/tundra_boulder2.nut
// Functions: 3
...
{
    this.addSprite("bottom").setBrush("tundra_stone_02_bottom");
    ...
    this.addSprite("top").setBrush("tundra_stone_02_top");
