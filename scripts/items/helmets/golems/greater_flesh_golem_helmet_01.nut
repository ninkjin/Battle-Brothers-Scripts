...
// Source: scripts/items/helmets/golems/greater_flesh_golem_helmet_01.nut
// Functions: 2

function create(this)
{
    this.helmet.create();
    this.m.ID = "armor.head.greater_flesh_golem_helmet_01";
    this.m.Name = "Mask of the Scholar";
