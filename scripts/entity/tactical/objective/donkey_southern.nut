...
// Source: scripts/entity/tactical/objective/donkey_southern.nut
// Functions: 2
...
function onPlacedOnMap(this)
{
    ...
    if (this.getTile().getNextTile([]["0"]) != null)
    {
        ...
        {
            this.Tactical.spawnEntity("scripts/entity/tactical/objects/cart_southern", this.getTile().getNextTile([]["0"]).Coords).setFlipped(true);
