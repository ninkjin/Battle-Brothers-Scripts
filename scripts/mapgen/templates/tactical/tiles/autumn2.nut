...
// Source: scripts/mapgen/templates/tactical/tiles/autumn2.nut
// Functions: 2

function init(this)
{
    this.m.Name = "tactical.tile.autumn2";
    this.m.MinX = 1;
    this.m.MinY = 1;
    this.createTileTransition().setBlendIntoSockets(true);
    this.createTileTransition().setBrush(this.Const.Direction.N, "transition_autumn_02_N");
    this.createTileTransition().setBrush(this.Const.Direction.NE, "transition_autumn_02_NE");
    this.createTileTransition().setBrush(this.Const.Direction.SE, "transition_autumn_02_SE");
    this.createTileTransition().setBrush(this.Const.Direction.S, "transition_autumn_02_S");
    this.createTileTransition().setBrush(this.Const.Direction.SW, "transition_autumn_02_SW");
    this.createTileTransition().setBrush(this.Const.Direction.NW, "transition_autumn_02_NW");
    this.createTileTransition().setSocket("socket_earth");
    this.Tactical.setTransitions("tile_autumn_02", this.createTileTransition());
    return;
}
...
function onFirstPass(this, _rect)
{
    ...
    this.Tactical.getTileSquare(_rect.X, _rect.Y).BlendPriority = this.Const.Tactical.TileBlendPriority.Autumn2;
    this.Tactical.getTileSquare(_rect.X, _rect.Y).IsBadTerrain = false;
    this.Tactical.getTileSquare(_rect.X, _rect.Y).setBrush("tile_autumn_02");
