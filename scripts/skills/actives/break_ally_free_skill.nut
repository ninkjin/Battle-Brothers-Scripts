this.break_ally_free_skill <- this.inherit("scripts/skills/skill", {
	...
	function create()
	{
		...
		this.m.Name = "解放盟友";
		this.m.Description = "利用你所能用到的一切，把附近的盟友从束缚他们的东西中解放出来。如果需要，可以砍、劈、割或啃！";
	...
	function getTooltip()
	{
		...
		return [
			...
			},
			{
				...
				text = "有[color=" + this.Const.UI.Color.PositiveValue + "]" + chance + "%[/color]基于近战技能的成功率，如果之前已有解放此盟友的尝试则更高。"
			}
		];
	}
