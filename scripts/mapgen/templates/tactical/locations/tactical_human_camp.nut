...
// Source: scripts/mapgen/templates/tactical/locations/tactical_human_camp.nut
// Functions: 3
                ...
                else
                {
                    if (this.Tactical.getTileSquare(_rect.X, _rect.Y).IsEmpty && this.Tactical.getTileSquare(_rect.X, _rect.Y).IsEmpty && this.Tactical.getTileSquare(_rect.X, _rect.Y).IsEmpty && this.Tactical.getTileSquare(_rect.X, _rect.Y).IsEmpty)
                    {
                        ...
                        if ((this.Math <= 1) && (this.Math <= 1))
                        {
                            ...
                            {
                                this.Tactical.getTileSquare(_rect.X, _rect.Y).spawnObject("entity/tactical/objects/human_camp_small_fireplace");
                            }
                            this.Tactical.getTileSquare(_rect.X, _rect.Y).spawnObject("entity/tactical/objects/human_camp_large_fireplace");
                        }
                        else
                        {
                            if (this.Math.rand(1, 100) <= 1)
                            {
                                ...
                                {
                                    this.Tactical.getTileSquare(_rect.X, _rect.Y).spawnObject("entity/tactical/objects/human_camp_wood");
                                }
                                this.Tactical.getTileSquare(_rect.X, _rect.Y).spawnObject("entity/tactical/objects/human_camp_furniture");
                            }
                            else
                            {
