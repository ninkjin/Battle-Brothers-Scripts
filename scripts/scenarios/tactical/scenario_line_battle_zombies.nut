...
// Source: scripts/scenarios/tactical/scenario_line_battle_zombies.nut
// Functions: 5
...
function initEntities(this)
{
    ...
    this.spawnEntity("scripts/entity/tactical/enemies/zombie", 19, 19, 11, 11).setFaction(this.Const.Faction.Undead);
    this.spawnEntity("scripts/entity/tactical/enemies/zombie", 19, 19, 11, 11).assignRandomEquipment();
    this.spawnEntity("scripts/entity/tactical/enemies/zombie_yeoman", 19, 19, 12, 12).setFaction(this.Const.Faction.Undead);
    this.spawnEntity("scripts/entity/tactical/enemies/zombie_yeoman", 19, 19, 12, 12).assignRandomEquipment();
    this.spawnEntity("scripts/entity/tactical/enemies/zombie_yeoman", 19, 19, 13, 13).setFaction(this.Const.Faction.Undead);
    this.spawnEntity("scripts/entity/tactical/enemies/zombie_yeoman", 19, 19, 13, 13).assignRandomEquipment();
    this.spawnEntity("scripts/entity/tactical/enemies/zombie", 19, 19, 14, 14).setFaction(this.Const.Faction.Undead);
    this.spawnEntity("scripts/entity/tactical/enemies/zombie", 19, 19, 14, 14).assignRandomEquipment();
    this.spawnEntity("scripts/entity/tactical/enemies/zombie_knight", 19, 19, 15, 15).setFaction(this.Const.Faction.Undead);
    this.spawnEntity("scripts/entity/tactical/enemies/zombie_knight", 19, 19, 15, 15).assignRandomEquipment();
    this.spawnEntity("scripts/entity/tactical/enemies/zombie", 19, 19, 16, 16).setFaction(this.Const.Faction.Undead);
    this.spawnEntity("scripts/entity/tactical/enemies/zombie", 19, 19, 16, 16).assignRandomEquipment();
    this.spawnEntity("scripts/entity/tactical/enemies/zombie_yeoman", 19, 19, 17, 17).setFaction(this.Const.Faction.Undead);
    this.spawnEntity("scripts/entity/tactical/enemies/zombie_yeoman", 19, 19, 17, 17).assignRandomEquipment();
    this.spawnEntity("scripts/entity/tactical/enemies/zombie_yeoman", 20, 20, 11, 11).setFaction(this.Const.Faction.Undead);
    this.spawnEntity("scripts/entity/tactical/enemies/zombie_yeoman", 20, 20, 11, 11).assignRandomEquipment();
    this.spawnEntity("scripts/entity/tactical/enemies/zombie_yeoman", 20, 20, 12, 12).setFaction(this.Const.Faction.Undead);
    this.spawnEntity("scripts/entity/tactical/enemies/zombie_yeoman", 20, 20, 12, 12).assignRandomEquipment();
    this.spawnEntity("scripts/entity/tactical/enemies/zombie_yeoman", 20, 20, 13, 13).setFaction(this.Const.Faction.Undead);
    this.spawnEntity("scripts/entity/tactical/enemies/zombie_yeoman", 20, 20, 13, 13).assignRandomEquipment();
    this.spawnEntity("scripts/entity/tactical/enemies/zombie", 20, 20, 14, 14).setFaction(this.Const.Faction.Undead);
    this.spawnEntity("scripts/entity/tactical/enemies/zombie", 20, 20, 14, 14).assignRandomEquipment();
    this.spawnEntity("scripts/entity/tactical/enemies/zombie_knight", 20, 20, 15, 15).setFaction(this.Const.Faction.Undead);
    this.spawnEntity("scripts/entity/tactical/enemies/zombie_knight", 20, 20, 15, 15).assignRandomEquipment();
    this.spawnEntity("scripts/entity/tactical/enemies/zombie_yeoman", 20, 20, 16, 16).setFaction(this.Const.Faction.Undead);
    this.spawnEntity("scripts/entity/tactical/enemies/zombie_yeoman", 20, 20, 16, 16).assignRandomEquipment();
    this.spawnEntity("scripts/entity/tactical/enemies/zombie", 20, 20, 17, 17).setFaction(this.Const.Faction.Undead);
    this.spawnEntity("scripts/entity/tactical/enemies/zombie", 20, 20, 17, 17).assignRandomEquipment();
    this.spawnEntity("scripts/entity/tactical/enemies/necromancer", 21, 21, 14, 14).setFaction(this.Const.Faction.Undead);
    this.spawnEntity("scripts/entity/tactical/enemies/necromancer", 21, 21, 14, 14).assignRandomEquipment();
    this.spawnEntity("scripts/entity/tactical/enemies/zombie_yeoman", 21, 21, 15, 15).setFaction(this.Const.Faction.Undead);
    this.spawnEntity("scripts/entity/tactical/enemies/zombie_yeoman", 21, 21, 15, 15).assignRandomEquipment();
    this.spawnEntity("scripts/entity/tactical/enemies/zombie_knight_bodyguard", 21, 21, 16, 16).setFaction(this.Const.Faction.Undead);
    this.spawnEntity("scripts/entity/tactical/enemies/zombie_knight_bodyguard", 21, 21, 16, 16).assignRandomEquipment();
    this.spawnEntity("scripts/entity/tactical/enemies/zombie_knight_bodyguard", 21, 21, 13, 13).setFaction(this.Const.Faction.Undead);
    this.spawnEntity("scripts/entity/tactical/enemies/zombie_knight_bodyguard", 21, 21, 13, 13).assignRandomEquipment();
    return;
}
