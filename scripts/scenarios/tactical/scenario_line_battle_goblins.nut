...
// Source: scripts/scenarios/tactical/scenario_line_battle_goblins.nut
// Functions: 5
...
function initEntities(this)
{
    ...
    this.spawnEntity("scripts/entity/tactical/player", 12, 12, 15, 15).getItems().equip(this.new("scripts/items/weapons/pike"));
    this.spawnEntity("scripts/entity/tactical/player", 12, 12, 15, 15).getItems().equip(this.new("scripts/items/accessory/wardog_item"));
    ...
    this.spawnEntity("scripts/entity/tactical/player", 12, 12, 13, 13).getItems().equip(this.new("scripts/items/weapons/pike"));
    ...
    this.spawnEntity("scripts/entity/tactical/player", 12, 12, 13, 13).getItems().equip(this.new("scripts/items/accessory/armored_wardog_item"));
    ...
    this.spawnEntity("scripts/entity/tactical/player", 11, 11, 14, 14).getItems().equip(this.new("scripts/items/accessory/armored_wardog_item"));
    ...
    this.spawnEntity("scripts/entity/tactical/player", 13, 13, 11, 11).getItems().equip(this.new("scripts/items/weapons/warbrand"));
    ...
    this.spawnEntity("scripts/entity/tactical/player", 13, 13, 13, 13).getItems().equip(this.new("scripts/items/armor/mail_shirt"));
    this.spawnEntity("scripts/entity/tactical/player", 13, 13, 13, 13).getItems().equip(this.new("scripts/items/weapons/hand_axe"));
    this.spawnEntity("scripts/entity/tactical/player", 13, 13, 13, 13).getItems().equip(this.new("scripts/items/shields/kite_shield"));
    ...
    this.spawnEntity("scripts/entity/tactical/player", 13, 13, 15, 15).getItems().equip(this.new("scripts/items/helmets/nasal_helmet"));
    this.spawnEntity("scripts/entity/tactical/player", 13, 13, 15, 15).getItems().equip(this.new("scripts/items/armor/mail_shirt"));
    this.spawnEntity("scripts/entity/tactical/player", 13, 13, 15, 15).getItems().equip(this.new("scripts/items/weapons/warhammer"));
    this.spawnEntity("scripts/entity/tactical/player", 13, 13, 15, 15).getItems().equip(this.new("scripts/items/shields/kite_shield"));
    ...
    this.spawnEntity("scripts/entity/tactical/player", 13, 13, 16, 16).getItems().equip(this.new("scripts/items/helmets/hood"));
    ...
    this.spawnEntity("scripts/entity/tactical/enemies/goblin_fighter", 19, 19, 11, 11).setFaction(this.Const.Faction.Goblins);
    this.spawnEntity("scripts/entity/tactical/enemies/goblin_fighter", 19, 19, 11, 11).assignRandomEquipment();
    this.spawnEntity("scripts/entity/tactical/enemies/goblin_fighter", 19, 19, 12, 12).setFaction(this.Const.Faction.Goblins);
    this.spawnEntity("scripts/entity/tactical/enemies/goblin_fighter", 19, 19, 12, 12).assignRandomEquipment();
    this.spawnEntity("scripts/entity/tactical/enemies/goblin_fighter", 19, 19, 13, 13).setFaction(this.Const.Faction.Goblins);
    this.spawnEntity("scripts/entity/tactical/enemies/goblin_fighter", 19, 19, 13, 13).assignRandomEquipment();
    this.spawnEntity("scripts/entity/tactical/enemies/goblin_fighter", 19, 19, 14, 14).setFaction(this.Const.Faction.Goblins);
    this.spawnEntity("scripts/entity/tactical/enemies/goblin_fighter", 19, 19, 14, 14).assignRandomEquipment();
    this.spawnEntity("scripts/entity/tactical/enemies/goblin_fighter", 19, 19, 15, 15).setFaction(this.Const.Faction.Goblins);
    this.spawnEntity("scripts/entity/tactical/enemies/goblin_fighter", 19, 19, 15, 15).assignRandomEquipment();
    this.spawnEntity("scripts/entity/tactical/enemies/goblin_fighter", 19, 19, 16, 16).setFaction(this.Const.Faction.Goblins);
    this.spawnEntity("scripts/entity/tactical/enemies/goblin_fighter", 19, 19, 16, 16).assignRandomEquipment();
    this.spawnEntity("scripts/entity/tactical/enemies/goblin_fighter", 19, 19, 17, 17).setFaction(this.Const.Faction.Goblins);
    this.spawnEntity("scripts/entity/tactical/enemies/goblin_fighter", 19, 19, 17, 17).assignRandomEquipment();
    this.spawnEntity("scripts/entity/tactical/enemies/goblin_ambusher", 20, 20, 11, 11).setFaction(this.Const.Faction.Goblins);
    this.spawnEntity("scripts/entity/tactical/enemies/goblin_ambusher", 20, 20, 11, 11).assignRandomEquipment();
    this.spawnEntity("scripts/entity/tactical/enemies/goblin_ambusher", 20, 20, 12, 12).setFaction(this.Const.Faction.Goblins);
    this.spawnEntity("scripts/entity/tactical/enemies/goblin_ambusher", 20, 20, 12, 12).assignRandomEquipment();
    this.spawnEntity("scripts/entity/tactical/enemies/goblin_ambusher", 20, 20, 13, 13).setFaction(this.Const.Faction.Goblins);
    this.spawnEntity("scripts/entity/tactical/enemies/goblin_ambusher", 20, 20, 13, 13).assignRandomEquipment();
    this.spawnEntity("scripts/entity/tactical/enemies/goblin_leader", 20, 20, 14, 14).setFaction(this.Const.Faction.Goblins);
    this.spawnEntity("scripts/entity/tactical/enemies/goblin_leader", 20, 20, 14, 14).assignRandomEquipment();
    this.spawnEntity("scripts/entity/tactical/enemies/goblin_shaman", 20, 20, 15, 15).setFaction(this.Const.Faction.Goblins);
    this.spawnEntity("scripts/entity/tactical/enemies/goblin_shaman", 20, 20, 15, 15).assignRandomEquipment();
    this.spawnEntity("scripts/entity/tactical/enemies/goblin_ambusher", 20, 20, 16, 16).setFaction(this.Const.Faction.Goblins);
    this.spawnEntity("scripts/entity/tactical/enemies/goblin_ambusher", 20, 20, 16, 16).assignRandomEquipment();
    this.spawnEntity("scripts/entity/tactical/enemies/goblin_ambusher", 20, 20, 17, 17).setFaction(this.Const.Faction.Goblins);
    this.spawnEntity("scripts/entity/tactical/enemies/goblin_ambusher", 20, 20, 17, 17).assignRandomEquipment();
    this.spawnEntity("scripts/entity/tactical/enemies/goblin_ambusher", 20, 20, 18, 18).setFaction(this.Const.Faction.Goblins);
    this.spawnEntity("scripts/entity/tactical/enemies/goblin_ambusher", 20, 20, 18, 18).assignRandomEquipment();
    return;
}

function initMap(this)
{
    this.Tactical.resizeScene(this.MapGen.get("tactical.plains").getMinX(), this.MapGen.get("tactical.plains").getMinY());
    this.MapGen.get("tactical.plains").fill({}, null);
    return;
}
