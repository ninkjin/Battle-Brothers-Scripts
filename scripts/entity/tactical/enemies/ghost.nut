...
// Source: scripts/entity/tactical/enemies/ghost.nut
// Functions: 4
...
function onInit(this)
{
    ...
    this.m.BaseProperties.setValues(this.Const.Tactical.Actor.Ghost);
    ...
    if ((this.World.Days >= this.Const.World.Scaling.Undead.GeistStatIncreaseDay) && (this.World.Days >= this.Const.World.Scaling.Undead.GeistStatIncreaseDay))
    {
        return ((this.World.Days >= this.Const.World.Scaling.Undead.GeistStatIncreaseDay) && (this.World.Days >= this.Const.World.Scaling.Undead.GeistStatIncreaseDay));
    ...
    this.addSprite("body").setBrush("bust_ghost_01");
    ...
    this.addSprite("head").setBrush("bust_ghost_01");
    ...
    this.addSprite("blur_1").setBrush("bust_ghost_01");
    ...
    this.addSprite("blur_2").setBrush("bust_ghost_01");
