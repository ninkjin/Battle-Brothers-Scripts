...
// Source: scripts/scenarios/tactical/scenario_line_battle_orcs.nut
// Functions: 5
...
function initEntities(this)
{
    ...
    this.World.getPlayerRoster().add(this.spawnEntity("scripts/entity/tactical/player", 10, 10, 13, 13));
    this.spawnEntity("scripts/entity/tactical/player", 10, 10, 13, 13).setName(this.getRandomPlayerName());
    this.spawnEntity("scripts/entity/tactical/player", 10, 10, 13, 13).setScenarioValues();
    this.spawnEntity("scripts/entity/tactical/player", 10, 10, 13, 13).getItems().equip(this.new("scripts/items/armor/leather_lamellar"));
    this.spawnEntity("scripts/entity/tactical/player", 10, 10, 13, 13).getItems().equip(this.new("scripts/items/tools/player_banner"));
    this.spawnEntity("scripts/entity/tactical/player", 10, 10, 13, 13).getItems().addToBag(this.new("scripts/items/weapons/dagger"));
    ...
    this.spawnEntity("scripts/entity/tactical/player", 13, 13, 12, 12).getItems().equip(this.new("scripts/items/armor/patched_mail_shirt"));
    this.spawnEntity("scripts/entity/tactical/player", 13, 13, 12, 12).getItems().equip(this.new("scripts/items/weapons/military_cleaver"));
    ...
    this.spawnEntity("scripts/entity/tactical/player", 13, 13, 14, 14).getItems().equip(this.new("scripts/items/helmets/flat_top_helmet"));
    ...
    this.spawnEntity("scripts/entity/tactical/player", 13, 13, 15, 15).getItems().equip(this.new("scripts/items/helmets/nasal_helmet_with_rusty_mail"));
    ...
    this.spawnEntity("scripts/entity/tactical/player", 13, 13, 17, 17).getItems().equip(this.new("scripts/items/weapons/two_handed_hammer"));
    this.spawnEntity("scripts/entity/tactical/enemies/orc_berserker", 19, 19, 11, 11).setFaction(this.Const.Faction.Orcs);
    this.spawnEntity("scripts/entity/tactical/enemies/orc_berserker", 19, 19, 11, 11).assignRandomEquipment();
    this.spawnEntity("scripts/entity/tactical/enemies/orc_young", 19, 19, 12, 12).setFaction(this.Const.Faction.Orcs);
    this.spawnEntity("scripts/entity/tactical/enemies/orc_young", 19, 19, 12, 12).assignRandomEquipment();
    this.spawnEntity("scripts/entity/tactical/enemies/orc_young", 19, 19, 13, 13).setFaction(this.Const.Faction.Orcs);
    this.spawnEntity("scripts/entity/tactical/enemies/orc_young", 19, 19, 13, 13).assignRandomEquipment();
    this.spawnEntity("scripts/entity/tactical/enemies/orc_young", 19, 19, 14, 14).setFaction(this.Const.Faction.Orcs);
    this.spawnEntity("scripts/entity/tactical/enemies/orc_young", 19, 19, 14, 14).assignRandomEquipment();
    this.spawnEntity("scripts/entity/tactical/enemies/orc_young", 19, 19, 15, 15).setFaction(this.Const.Faction.Orcs);
    this.spawnEntity("scripts/entity/tactical/enemies/orc_young", 19, 19, 15, 15).assignRandomEquipment();
    this.spawnEntity("scripts/entity/tactical/enemies/orc_young", 19, 19, 16, 16).setFaction(this.Const.Faction.Orcs);
    this.spawnEntity("scripts/entity/tactical/enemies/orc_young", 19, 19, 16, 16).assignRandomEquipment();
    this.spawnEntity("scripts/entity/tactical/enemies/orc_berserker", 19, 19, 17, 17).setFaction(this.Const.Faction.Orcs);
    this.spawnEntity("scripts/entity/tactical/enemies/orc_berserker", 19, 19, 17, 17).assignRandomEquipment();
    this.spawnEntity("scripts/entity/tactical/enemies/orc_young", (19 + 1), (19 + 1), 12, 12).setFaction(this.Const.Faction.Orcs);
    this.spawnEntity("scripts/entity/tactical/enemies/orc_young", (19 + 1), (19 + 1), 12, 12).assignRandomEquipment();
    this.spawnEntity("scripts/entity/tactical/enemies/orc_warrior", (19 + 1), (19 + 1), 13, 13).setFaction(this.Const.Faction.Orcs);
    this.spawnEntity("scripts/entity/tactical/enemies/orc_warrior", (19 + 1), (19 + 1), 13, 13).assignRandomEquipment();
    this.spawnEntity("scripts/entity/tactical/enemies/orc_warlord", (19 + 1), (19 + 1), 14, 14).setFaction(this.Const.Faction.Orcs);
    this.spawnEntity("scripts/entity/tactical/enemies/orc_warlord", (19 + 1), (19 + 1), 14, 14).assignRandomEquipment();
    this.spawnEntity("scripts/entity/tactical/enemies/orc_young", (19 + 1), (19 + 1), 15, 15).setFaction(this.Const.Faction.Orcs);
    this.spawnEntity("scripts/entity/tactical/enemies/orc_young", (19 + 1), (19 + 1), 15, 15).assignRandomEquipment();
    this.spawnEntity("scripts/entity/tactical/enemies/orc_warrior", (19 + 1), (19 + 1), 16, 16).setFaction(this.Const.Faction.Orcs);
    this.spawnEntity("scripts/entity/tactical/enemies/orc_warrior", (19 + 1), (19 + 1), 16, 16).assignRandomEquipment();
    return;
}
