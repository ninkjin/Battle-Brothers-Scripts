this.small_mountains_fort <- this.inherit("scripts/entity/world/settlement", {
	m = {},
	function create()
	{
		...
		this.m.UIDescription = "一个建立在山中的小型防御工事";
		this.m.Description = "一个小型防御工事被建在了这片山地中，作为行动基地来控制周围土地。";
