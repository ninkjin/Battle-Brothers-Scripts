...
// Source: scripts/mapgen/templates/tactical/test/test_plains.nut
// Functions: 2
    ...
    while (r14)
    {
        if (true)
        {
            ...
            else
            {
                ...
                {
                    if (((this.Math.rand(5, (_rect.H - 5) + 11) - 1) >= 1))
                    {
                    }
                }
            }
        }
        [].push(this.MapGen.get("tactical.test_plains_clearing"));
        if (8 != 0)
        {
        ...
        if (_rect.X < (_rect.X + _rect.W))
        {
            ...
            {
                if ((_rect.Y <= 22) && (_rect.Y <= 22) && (_rect.Y <= 22))
                {
                    return ((_rect.Y <= 22) && (_rect.Y <= 22) && (_rect.Y <= 22));
                ...
                else
                {
                    ...
                    this.Tactical.getTileSquare(_rect.X, _rect.Y).Level = 0;
                    if (this.Math.rand(0, 100) > (100 - ((((0 + 16) + 16) + 16) * 25)))
                    {
