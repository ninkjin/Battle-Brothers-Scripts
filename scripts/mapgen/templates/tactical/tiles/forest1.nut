...
// Source: scripts/mapgen/templates/tactical/tiles/forest1.nut
// Functions: 5
...
function fillWithMushrooms(this, _rect, _properties, _pass)
{
    ...
    this.Tactical.getTileSquare(_rect.X, _rect.Y).setBrush("tile_forest_01");
...
function init(this)
{
    ...
    this.createTileTransition().setBrush(this.Const.Direction.N, "transition_forest_01_N");
    this.createTileTransition().setBrush(this.Const.Direction.NE, "transition_forest_01_NE");
    this.createTileTransition().setBrush(this.Const.Direction.SE, "transition_forest_01_SE");
    this.createTileTransition().setBrush(this.Const.Direction.S, "transition_forest_01_S");
    this.createTileTransition().setBrush(this.Const.Direction.SW, "transition_forest_01_SW");
    this.createTileTransition().setBrush(this.Const.Direction.NW, "transition_forest_01_NW");
    this.createTileTransition().setSocket("socket_earth");
    this.Tactical.setTransitions("tile_forest_01", this.createTileTransition());
    return;
}
