...
// Source: scripts/mapgen/templates/tactical/tiles/tundra1.nut
// Functions: 2
...
function init(this)
{
    ...
    this.createTileTransition().setBrush(this.Const.Direction.N, "transition_tundra_01_N");
    this.createTileTransition().setBrush(this.Const.Direction.NE, "transition_tundra_01_NE");
    this.createTileTransition().setBrush(this.Const.Direction.SE, "transition_tundra_01_SE");
    this.createTileTransition().setBrush(this.Const.Direction.S, "transition_tundra_01_S");
    this.createTileTransition().setBrush(this.Const.Direction.SW, "transition_tundra_01_SW");
    this.createTileTransition().setBrush(this.Const.Direction.NW, "transition_tundra_01_NW");
    this.createTileTransition().setSocket("socket_earth");
    this.Tactical.setTransitions("tile_tundra_01", this.createTileTransition());
    return;
}
...
function onFirstPass(this, _rect)
{
    ...
    this.Tactical.getTileSquare(_rect.X, _rect.Y).BlendPriority = this.Const.Tactical.TileBlendPriority.Tundra1;
    this.Tactical.getTileSquare(_rect.X, _rect.Y).IsBadTerrain = false;
    this.Tactical.getTileSquare(_rect.X, _rect.Y).setBrush("tile_tundra_01");
