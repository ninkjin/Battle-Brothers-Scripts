...
// Source: scripts/items/weapons/golems/golem_mace_flail.nut
// Functions: 3
...
function create(this)
{
    ...
    this.m.icon_dual_mace_flail_01 = "RangeMin";
    this.m.RangeMax = 1;
    this.m.RangeIdeal = 1;
    this.m.Value = 1;
    this.m.Condition = 0;
...
function onEquip(this)
{
    ...
    this.new("scripts/skills/actives/golem_lash_skill").m.Icon = "skills/active_92.png";
    this.new("scripts/skills/actives/golem_lash_skill").m.IconDisabled = "skills/active_92_sw.png";
    this.new("scripts/skills/actives/golem_lash_skill").m.Overlay = "active_92";
    this.addSkill(this.new("scripts/skills/actives/golem_lash_skill"));
    return;
}
