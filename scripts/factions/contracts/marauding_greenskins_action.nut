...
// Source: scripts/factions/contracts/marauding_greenskins_action.nut
// Functions: 4
...
{
    this.new("scripts/contracts/contracts/marauding_greenskins_contract").setFaction(_faction.getID());
    this.new("scripts/contracts/contracts/marauding_greenskins_contract").setEmployerID(_faction.getRandomCharacter().getID());
    this.new("scripts/contracts/contracts/marauding_greenskins_contract").setOrigin(this.m.Origin);
    this.World.Contracts.addContract(this.new("scripts/contracts/contracts/marauding_greenskins_contract"));
    return;
}
