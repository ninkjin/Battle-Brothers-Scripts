...
// Source: scripts/mapgen/templates/tactical/tiles/grass2.nut
// Functions: 4
...
function init(this)
{
    this.m.Name = "tactical.tile.grass2";
    this.m.MinX = 1;
    this.m.MinY = 1;
    this.createTileTransition().setBlendIntoSockets(true);
    this.createTileTransition().setBrush(this.Const.Direction.N, "transition_grass_02_N");
    this.createTileTransition().setBrush(this.Const.Direction.NE, "transition_grass_02_NE");
    this.createTileTransition().setBrush(this.Const.Direction.SE, "transition_grass_02_SE");
    this.createTileTransition().setBrush(this.Const.Direction.S, "transition_grass_02_S");
    this.createTileTransition().setBrush(this.Const.Direction.SW, "transition_grass_02_SW");
    this.createTileTransition().setBrush(this.Const.Direction.NW, "transition_grass_02_NW");
    this.createTileTransition().setSocket("socket_earth");
    this.Tactical.setTransitions("tile_grass_02", this.createTileTransition());
    return;
}
...
function onFirstPass(this, _rect)
{
    ...
    this.Tactical.getTileSquare(_rect.X, _rect.Y).BlendPriority = this.Const.Tactical.TileBlendPriority.Grass2;
    this.Tactical.getTileSquare(_rect.X, _rect.Y).setBrush("tile_grass_02");
