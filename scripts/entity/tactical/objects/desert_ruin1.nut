...
// Source: scripts/entity/tactical/objects/desert_ruin1.nut
// Functions: 3
...
{
    this.addSprite("bottom").setBrush("desert_detail_ruins_01_bottom");
    ...
    this.addSprite("top").setBrush("desert_detail_ruins_01_top");
