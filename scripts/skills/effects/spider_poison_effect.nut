this.spider_poison_effect <- this.inherit("scripts/skills/skill", {
	...
	{
		return "这个角色血管中正流淌着一种恶毒的毒素，每回合将会失去[color=" + this.Const.UI.Color.NegativeValue + "]" + this.m.Damage + "[/color]生命值，持续[color=" + this.Const.UI.Color.NegativeValue + "]" + this.m.TurnsLeft + "[/color]回合。";
	}
