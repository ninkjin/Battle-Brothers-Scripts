this.ifrit_potion_effect <- this.inherit("scripts/skills/skill", {
	...
	{
		return "这个角色的皮肤发生了变异，现在开始形成坚硬如石头一般更加难以刺穿的皮肤块。当这些皮肤块破损时，它们会通过一个明显又疼又不舒服的过程逐渐重新形成。你应该告诉他不要再扣那个痂了。";
	}
	...
	function getTooltip()
	{
		local ret = [
			...
			},
			{
				...
				text = "这个角色的皮肤硬如石头，增加[color=" + this.Const.UI.Color.PositiveValue + "]25[/color]点天然护甲"
			},
			{
				id = 12,
				type = "hint",
