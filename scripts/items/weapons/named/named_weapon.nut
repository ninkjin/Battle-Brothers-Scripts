this.named_weapon <- this.inherit("scripts/items/weapons/weapon", {
	...
	function createRandomName()
	{
		...
		{
			return this.getRandomCharacterName(this.Const.Strings.KnightNames) + "的" + this.m.NameList[this.Math.rand(0, this.m.NameList.len() - 1)];
		}
		else
		{
			return this.getRandomCharacterName(this.Const.Strings.BanditLeaderNames) + "的" + this.m.NameList[this.Math.rand(0, this.m.NameList.len() - 1)];
		}
	}
