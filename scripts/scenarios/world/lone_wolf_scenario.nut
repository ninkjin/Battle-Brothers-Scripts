this.lone_wolf_scenario <- this.inherit("scripts/scenarios/world/starting_scenario", {
	...
	function create()
	{
		...
		this.m.Name = "独狼";
		this.m.Description = "[p=c][img]gfx/ui/events/event_35.png[/img][/p][p]你已经独自旅行很长时间了，参加骑枪竞技，并和年轻的贵族们比武。作为一名跟树一样高的野骑士，你永远不会长期需要其他任何人。之后也会如此吗？\n\n[color=#bcad8c]独狼：[/color]以一个装备精良的野骑士开始游戏，但启动资金很低。\n[color=#bcad8c]少数精英：[/color]你的名册上不能超过12个人。\n[color=#bcad8c]化身：[/color]如果你的野骑士死了，战役就结束了。[/p]";
		this.m.Difficulty = 3;
		this.m.Order = 110;
	...
	function onSpawnAssets()
	{
		...
		bro.getBackground().m.RawDescription = "作为一名漂泊的野骑士，你是一名骑枪竞技和比武大赛的老手，你在获得胜利上也是一名老手。对许多人来说，这是一个可怕的想法，但如果说有什么东西让你的目光转向佣兵的工作，那就是无聊。表面上你说这是为了钱，但你知道有一部分也是为了伙伴。";
