...
// Source: scripts/mapgen/templates/tactical/tiles/earth2.nut
// Functions: 2
...
function init(this)
{
    ...
    this.Tactical.setTransitions("tile_earth_02", this.createTileTransition());
    return;
}
...
function onFirstPass(this, _rect)
{
    ...
    this.Tactical.getTileSquare(_rect.X, _rect.Y).setBrush("tile_earth_02");
