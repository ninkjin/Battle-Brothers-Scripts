...
// Source: scripts/entity/tactical/objects/desert_ruin2.nut
// Functions: 3
...
{
    this.addSprite("bottom").setBrush("desert_detail_ruins_02_bottom");
    ...
    this.addSprite("top").setBrush("desert_detail_ruins_02_top");
