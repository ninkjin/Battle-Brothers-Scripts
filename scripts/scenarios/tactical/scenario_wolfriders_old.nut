...
// Source: scripts/scenarios/tactical/scenario_wolfriders_old.nut
// Functions: 5
...
function initEntities(this)
{
    ...
    this.spawnEntity("scripts/entity/tactical/enemies/goblin_wolfrider", 19, 19, 11, 11).setFaction(this.Const.Faction.Goblins);
    this.spawnEntity("scripts/entity/tactical/enemies/goblin_wolfrider", 19, 19, 11, 11).assignRandomEquipment();
    this.spawnEntity("scripts/entity/tactical/enemies/goblin_wolfrider", 19, 19, 12, 12).setFaction(this.Const.Faction.Goblins);
    this.spawnEntity("scripts/entity/tactical/enemies/goblin_wolfrider", 19, 19, 12, 12).assignRandomEquipment();
    this.spawnEntity("scripts/entity/tactical/enemies/goblin_wolfrider", 19, 19, 13, 13).setFaction(this.Const.Faction.Goblins);
    this.spawnEntity("scripts/entity/tactical/enemies/goblin_wolfrider", 19, 19, 13, 13).assignRandomEquipment();
    this.spawnEntity("scripts/entity/tactical/enemies/goblin_wolfrider", 19, 19, 14, 14).setFaction(this.Const.Faction.Goblins);
    this.spawnEntity("scripts/entity/tactical/enemies/goblin_wolfrider", 19, 19, 14, 14).assignRandomEquipment();
    this.spawnEntity("scripts/entity/tactical/enemies/goblin_wolfrider", 19, 19, 15, 15).setFaction(this.Const.Faction.Goblins);
    this.spawnEntity("scripts/entity/tactical/enemies/goblin_wolfrider", 19, 19, 15, 15).assignRandomEquipment();
    this.spawnEntity("scripts/entity/tactical/enemies/goblin_wolfrider", 19, 19, 16, 16).setFaction(this.Const.Faction.Goblins);
    this.spawnEntity("scripts/entity/tactical/enemies/goblin_wolfrider", 19, 19, 16, 16).assignRandomEquipment();
    this.spawnEntity("scripts/entity/tactical/enemies/goblin_wolfrider", 19, 19, 17, 17).setFaction(this.Const.Faction.Goblins);
    this.spawnEntity("scripts/entity/tactical/enemies/goblin_wolfrider", 19, 19, 17, 17).assignRandomEquipment();
    this.spawnEntity("scripts/entity/tactical/enemies/goblin_wolfrider", 20, 20, 11, 11).setFaction(this.Const.Faction.Goblins);
    this.spawnEntity("scripts/entity/tactical/enemies/goblin_wolfrider", 20, 20, 11, 11).assignRandomEquipment();
    this.spawnEntity("scripts/entity/tactical/enemies/goblin_wolfrider", 20, 20, 12, 12).setFaction(this.Const.Faction.Goblins);
    this.spawnEntity("scripts/entity/tactical/enemies/goblin_wolfrider", 20, 20, 12, 12).assignRandomEquipment();
    this.spawnEntity("scripts/entity/tactical/enemies/goblin_wolfrider", 20, 20, 13, 13).setFaction(this.Const.Faction.Goblins);
    this.spawnEntity("scripts/entity/tactical/enemies/goblin_wolfrider", 20, 20, 13, 13).assignRandomEquipment();
    this.spawnEntity("scripts/entity/tactical/enemies/goblin_wolfrider", 20, 20, 16, 16).setFaction(this.Const.Faction.Goblins);
    this.spawnEntity("scripts/entity/tactical/enemies/goblin_wolfrider", 20, 20, 16, 16).assignRandomEquipment();
    this.spawnEntity("scripts/entity/tactical/enemies/goblin_wolfrider", 20, 20, 17, 17).setFaction(this.Const.Faction.Goblins);
    this.spawnEntity("scripts/entity/tactical/enemies/goblin_wolfrider", 20, 20, 17, 17).assignRandomEquipment();
    this.spawnEntity("scripts/entity/tactical/enemies/goblin_wolfrider", 20, 20, 18, 18).setFaction(this.Const.Faction.Goblins);
    this.spawnEntity("scripts/entity/tactical/enemies/goblin_wolfrider", 20, 20, 18, 18).assignRandomEquipment();
    return;
}
