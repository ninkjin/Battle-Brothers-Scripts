...
// Source: scripts/mapgen/templates/tactical/tiles/stone2.nut
// Functions: 2
...
function init(this)
{
    ...
    this.createTileTransition().setBrush(this.Const.Direction.N, "transition_autumn_05_N");
    this.createTileTransition().setBrush(this.Const.Direction.NE, "transition_autumn_05_NE");
    this.createTileTransition().setBrush(this.Const.Direction.SE, "transition_autumn_05_SE");
    this.createTileTransition().setBrush(this.Const.Direction.S, "transition_autumn_05_S");
    this.createTileTransition().setBrush(this.Const.Direction.SW, "transition_autumn_05_SW");
    this.createTileTransition().setBrush(this.Const.Direction.NW, "transition_autumn_05_NW");
    this.createTileTransition().setSocket("socket_stone");
    this.Tactical.setTransitions("tile_stone_02", this.createTileTransition());
    return;
}
...
function onFirstPass(this, _rect)
{
    ...
    this.Tactical.getTileSquare(_rect.X, _rect.Y).BlendPriority = this.Const.Tactical.TileBlendPriority.Stone2;
    this.Tactical.getTileSquare(_rect.X, _rect.Y).IsBadTerrain = false;
    this.Tactical.getTileSquare(_rect.X, _rect.Y).setBrush("tile_stone_02");
