this.light_padding_replacement_upgrade <- this.inherit("scripts/items/armor_upgrades/armor_upgrade", {
	...
	function create()
	{
		...
		this.m.Name = "轻质内衬备件";
		this.m.Description = "由奇异的材料制成，这种内衬备件能以较轻的重量提供和通常内衬相同的防护。";
		this.m.ArmorDescription = "这件护甲已经换用了一种轻质但不失耐久的内衬。";
	...
	function getTooltip()
	{
		...
		result.push({
			...
			text = "使一件护甲的最大疲劳惩罚减少[color=" + this.Const.UI.Color.NegativeValue + "]20%[/color]"
		});
		return result;
	}
