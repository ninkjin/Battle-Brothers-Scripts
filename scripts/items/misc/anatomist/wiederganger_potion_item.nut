this.wiederganger_potion_item <- this.inherit("scripts/items/misc/anatomist/anatomist_potion_item", {
	...
	function create()
	{
		...
		this.m.Name = "革制外皮药剂";
		this.m.Description = "饮用后，这种强大的混合物会改变肌肉使得其可以立刻对突然的打击产生反应，从而保护身体免受严重伤害！别介意它的气味，味道越大效力越强。";
		this.m.IconLarge = "";
	...
	function getTooltip()
	{
		...
		result.push({
			...
			text = "被击中时遭受伤势的阈值提高[color=" + this.Const.UI.Color.PositiveValue + "]33%[/color]"
		});
		result.push({
			id = 65,
			type = "text",
