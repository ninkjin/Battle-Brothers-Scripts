...
// Source: scripts/mapgen/templates/tactical/tiles/steppe2.nut
// Functions: 2
...
function init(this)
{
    ...
    this.createTileTransition().setBrush(this.Const.Direction.N, "transition_steppe_02_N");
    this.createTileTransition().setBrush(this.Const.Direction.NE, "transition_steppe_02_NE");
    this.createTileTransition().setBrush(this.Const.Direction.SE, "transition_steppe_02_SE");
    this.createTileTransition().setBrush(this.Const.Direction.S, "transition_steppe_02_S");
    this.createTileTransition().setBrush(this.Const.Direction.SW, "transition_steppe_02_SW");
    this.createTileTransition().setBrush(this.Const.Direction.NW, "transition_steppe_02_NW");
    this.createTileTransition().setSocket("socket_steppe");
    this.Tactical.setTransitions("tile_steppe_02", this.createTileTransition());
    return;
}
...
function onFirstPass(this, _rect)
{
    ...
    this.Tactical.getTileSquare(_rect.X, _rect.Y).BlendPriority = this.Const.Tactical.TileBlendPriority.Steppe2;
    this.Tactical.getTileSquare(_rect.X, _rect.Y).IsBadTerrain = false;
    this.Tactical.getTileSquare(_rect.X, _rect.Y).setBrush("tile_steppe_02");
