...
// Source: scripts/skills/backgrounds/companion_1h_southern_background.nut
// Functions: 2
...
function create(this)
{
    ...
    this.m.Ethnicity = 1;
    this.m.Excluded = ["trait.superstitious", "trait.hate_undead", "trait.hate_beasts", "trait.hate_greenskins", "trait.huge", "trait.weasel", "trait.fear_undead", "trait.fear_beasts", "trait.fear_greenskins", "trait.paranoid", "trait.night_blind", "trait.ailing", "trait.impatient", "trait.asthmatic", "trait.greedy", "trait.dumb", "trait.clubfooted", "trait.drunkard", "trait.disloyal", "trait.tiny", "trait.fragile", "trait.clumsy", "trait.fainthearted", "trait.craven", "trait.bleeder", "trait.dastard", "trait.insecure"];
...
function onAddEquipment(this)
{
    ...
    this.getContainer().getActor().getTalents()["this.Const.Attributes.Hitpoints"] = 2;
    this.getContainer().getActor().getTalents()["this.Const.Attributes.Fatigue"] = 1;
    this.getContainer().getActor().getTalents()["this.Const.Attributes.Bravery"] = 1;
    this.getContainer().getActor().getItems().equip(this.new("scripts/items/weapons/oriental/firelance"));
    this.getContainer().getActor().getItems().equip(this.new("scripts/items/shields/oriental/southern_light_shield"));
