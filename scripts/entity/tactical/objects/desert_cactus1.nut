...
// Source: scripts/entity/tactical/objects/desert_cactus1.nut
// Functions: 3
...
{
    this.addSprite("bottom").setBrush((("desert_cactus_" + []["this.Math.rand(0, ([].len() - 1))"]) + "_bottom"));
    ...
    this.addSprite("top").setBrush((("desert_cactus_" + []["this.Math.rand(0, ([].len() - 1))"]) + "_top"));
