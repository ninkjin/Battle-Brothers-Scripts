this.pimp_vs_harlot_event <- this.inherit("scripts/events/event", {
	...
	function create()
	{
		...
		this.m.Screens.push({
			ID = "Monk",
			Text = "[img]gfx/ui/events/event_92.png[/img]%monk% 这个僧侣走上前。 他抓住皮条客的手。 如果你那样做，皮条客肯定会退缩或打你。 但这位圣人是如此优雅和谦逊，皮条客只是盯着他看。 僧侣热情地笑了。%SPEECH_ON%这不是你要走的路，这一点很清楚。 你没有办法对付这个女人，而这只是一个女人，而皮条客需要很多。 古神告诉我，你注定要走另一条路，一条适合更坚强的人的路。 我想说你适合加入一个雇佣兵战队。 把女人们的争吵留给蛇头吧。%SPEECH_OFF%皮条客想了一会儿，但你可以看出他已经被这些话打动了。 他问你是否愿意接受他加入你的战队。",
			Image = "",
			List = [],
			Characters = [],
			Options = [
			...
			function start( _event )
			{
				...
				_event.m.Dude.setTitle("皮条客");
				_event.m.Dude.getBackground().m.RawDescription = "在访问" + _event.m.Town.getName() + "期间，你发现%name%正在和他唯一的妓女争吵。" + _event.m.Monk.getName() + "说服他加入了战团，并且你同意带上他。希望他在盾墙里战斗的水平比和妓女吵架要高。";
