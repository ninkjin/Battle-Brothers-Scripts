...
// Source: scripts/mapgen/templates/tactical/tiles/tundra3.nut
// Functions: 2
...
function init(this)
{
    ...
    this.createTileTransition().setBrush(this.Const.Direction.N, "transition_tundra_03_N");
    this.createTileTransition().setBrush(this.Const.Direction.NE, "transition_tundra_03_NE");
    this.createTileTransition().setBrush(this.Const.Direction.SE, "transition_tundra_03_SE");
    this.createTileTransition().setBrush(this.Const.Direction.S, "transition_tundra_03_S");
    this.createTileTransition().setBrush(this.Const.Direction.SW, "transition_tundra_03_SW");
    this.createTileTransition().setBrush(this.Const.Direction.NW, "transition_tundra_03_NW");
    this.createTileTransition().setSocket("socket_earth");
    this.Tactical.setTransitions("tile_tundra_03", this.createTileTransition());
    return;
}
...
function onFirstPass(this, _rect)
{
    ...
    this.Tactical.getTileSquare(_rect.X, _rect.Y).BlendPriority = this.Const.Tactical.TileBlendPriority.Tundra3;
    this.Tactical.getTileSquare(_rect.X, _rect.Y).IsBadTerrain = false;
    this.Tactical.getTileSquare(_rect.X, _rect.Y).setBrush("tile_tundra_03");
