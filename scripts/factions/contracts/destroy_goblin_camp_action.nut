...
// Source: scripts/factions/contracts/destroy_goblin_camp_action.nut
// Functions: 4
...
{
    this.new("scripts/contracts/contracts/destroy_goblin_camp_contract").setFaction(_faction.getID());
    this.new("scripts/contracts/contracts/destroy_goblin_camp_contract").setEmployerID(_faction.getRandomCharacter().getID());
    this.new("scripts/contracts/contracts/destroy_goblin_camp_contract").setOrigin(this.m.Origin);
    this.World.Contracts.addContract(this.new("scripts/contracts/contracts/destroy_goblin_camp_contract"));
    return;
}
