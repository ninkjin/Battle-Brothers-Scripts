...
// Source: scripts/entity/tactical/objects/steppe_boulder3.nut
// Functions: 3
...
{
    this.addSprite("bottom").setBrush("steppe_stone_03_bottom");
    ...
    this.addSprite("top").setBrush("steppe_stone_03_top");
