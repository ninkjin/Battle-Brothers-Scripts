this.coat_with_spider_poison_skill <- this.inherit("scripts/skills/skill", {
	...
	function create()
	{
		...
		this.m.Name = "使用毒油";
		this.m.Description = "将你的武器和箭头涂上毒药。无法在卷入近战时使用。";
	...
	function getTooltip()
	{
		local ret = [
			...
			},
			{
				...
				text = "下[color=" + this.Const.UI.Color.PositiveValue + "]4[/color]次攻击会施加中毒状态效果，造成每回合[color=" + this.Const.UI.Color.NegativeValue + "]10[/color]伤害。"
			}
		];
