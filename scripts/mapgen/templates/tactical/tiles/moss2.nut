...
// Source: scripts/mapgen/templates/tactical/tiles/moss2.nut
// Functions: 5
...
function init(this)
{
    this.m.Name = "tactical.tile.moss2";
    this.m.MinX = 1;
    this.m.MinY = 1;
    this.createTileTransition().setBlendIntoSockets(false);
    this.createTileTransition().setBrush(this.Const.Direction.N, "transition_moss_02_N");
    this.createTileTransition().setBrush(this.Const.Direction.NE, "transition_moss_02_NE");
    this.createTileTransition().setBrush(this.Const.Direction.SE, "transition_moss_02_SE");
    this.createTileTransition().setBrush(this.Const.Direction.S, "transition_moss_02_S");
    this.createTileTransition().setBrush(this.Const.Direction.SW, "transition_moss_02_SW");
    this.createTileTransition().setBrush(this.Const.Direction.NW, "transition_moss_02_NW");
    this.createTileTransition().setSocket("socket_earth");
    this.Tactical.setTransitions("tile_moss_02", this.createTileTransition());
    return;
}
