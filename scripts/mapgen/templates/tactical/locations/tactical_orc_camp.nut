...
// Source: scripts/mapgen/templates/tactical/locations/tactical_orc_camp.nut
// Functions: 3
        ...
        if (_rect.Y < (_rect.Y + _rect.H))
        {
            ...
            else
            {
                ...
                if (this.Tactical.getTileSquare(_rect.X, _rect.Y).IsEmpty && this.Tactical.getTileSquare(_rect.X, _rect.Y).IsEmpty && this.Tactical.getTileSquare(_rect.X, _rect.Y).IsEmpty && this.Tactical.getTileSquare(_rect.X, _rect.Y).IsEmpty)
                {
                    ...
                    if (this.Math.rand(1, 100) <= (3 + ((0 + 15) * 3)))
                    {
                        this.Tactical.getTileSquare(_rect.X, _rect.Y).clear();
                        if (this.Math.rand(1, 4) == 1)
                        {
                            this.Tactical.getTileSquare(_rect.X, _rect.Y).spawnObject("entity/tactical/objects/orc_camp_small_remains");
                        }
                        else
                        {
                        ...
                        else
                        {
                            ...
                            else
                            {
                                if (this.Math.rand(1, 100) <= 2)
                                {
                                    ...
                                    if (this.Math.rand(1, 3) == 1)
                                    {
                                        this.Tactical.getTileSquare(_rect.X, _rect.Y).spawnObject("entity/tactical/objects/orc_camp_small_idol");
                                    }
                                    this.Tactical.getTileSquare(_rect.X, _rect.Y).spawnObject("entity/tactical/objects/orc_camp_idol");
                                }
                                else
                                {
                                    if ((this.Math <= 2) && (this.Math <= 2))
                                    {
                                        ...
                                        this.Tactical.getTileSquare(_rect.X, _rect.Y).clear();
                                        this.Tactical.getTileSquare(_rect.X, _rect.Y).spawnObject("entity/tactical/objects/orc_camp_standard");
                                    }
                                    else
                                    {
