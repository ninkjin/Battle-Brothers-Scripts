...
// Source: scripts/scenarios/tactical/scenario_ghouls.nut
// Functions: 5
...
function generate(this)
{
    ...
    if (0 < 8)
    {
        this.spawnEntity("scripts/entity/tactical/humans/militia").assignRandomEquipment();
        this.spawnEntity("scripts/entity/tactical/humans/militia").killSilently();
    }
...
function initEntities(this)
{
    ...
    this.spawnEntity("scripts/entity/tactical/player", 14, 16, 14, 16).setName(this.getRandomPlayerName());
    this.spawnEntity("scripts/entity/tactical/player", 14, 16, 14, 16).setScenarioValues();
    this.spawnEntity("scripts/entity/tactical/player", 14, 16, 14, 16).getItems().equip(this.new("scripts/items/helmets/named/norse_helmet"));
    ...
    this.spawnEntity("scripts/entity/tactical/player", 14, 16, 14, 16).getItems().equip(this.new("scripts/items/shields/named/named_red_white_shield"));
    this.World.getPlayerRoster().add(this.spawnEntity("scripts/entity/tactical/player", 14, 16, 14, 16));
    this.spawnEntity("scripts/entity/tactical/player", 14, 16, 14, 16).setFaction(this.Const.Faction.Player);
    this.spawnEntity("scripts/entity/tactical/player", 14, 16, 14, 16).setName(this.getRandomPlayerName());
    this.spawnEntity("scripts/entity/tactical/player", 14, 16, 14, 16).setScenarioValues();
    ...
    this.spawnEntity("scripts/entity/tactical/player", 14, 16, 14, 16).getItems().equip(this.new("scripts/items/ammo/quiver_of_arrows"));
    this.spawnEntity("scripts/entity/tactical/player", 14, 16, 14, 16).getItems().addToBag(this.new("scripts/items/weapons/dagger"));
    this.spawnEntity("scripts/entity/tactical/enemies/ghoul", 12, 18, 7, 10).setFaction(this.Const.Faction.Undead);
    this.spawnEntity("scripts/entity/tactical/enemies/ghoul", 12, 18, 7, 10).assignRandomEquipment();
    this.spawnEntity("scripts/entity/tactical/enemies/ghoul", 12, 18, 7, 10).setFaction(this.Const.Faction.Undead);
    this.spawnEntity("scripts/entity/tactical/enemies/ghoul", 12, 18, 7, 10).assignRandomEquipment();
    this.spawnEntity("scripts/entity/tactical/enemies/ghoul", 12, 18, 7, 10).setFaction(this.Const.Faction.Undead);
    this.spawnEntity("scripts/entity/tactical/enemies/ghoul", 12, 18, 7, 10).assignRandomEquipment();
    this.spawnEntity("scripts/entity/tactical/enemies/ghoul", 12, 18, 7, 10).setFaction(this.Const.Faction.Undead);
    this.spawnEntity("scripts/entity/tactical/enemies/ghoul", 12, 18, 7, 10).assignRandomEquipment();
    this.spawnEntity("scripts/entity/tactical/enemies/ghoul", 20, 22, 12, 18).setFaction(this.Const.Faction.Undead);
    this.spawnEntity("scripts/entity/tactical/enemies/ghoul", 20, 22, 12, 18).assignRandomEquipment();
    this.spawnEntity("scripts/entity/tactical/enemies/ghoul", 20, 22, 12, 18).setFaction(this.Const.Faction.Undead);
    this.spawnEntity("scripts/entity/tactical/enemies/ghoul", 20, 22, 12, 18).assignRandomEquipment();
    this.spawnEntity("scripts/entity/tactical/enemies/ghoul", 20, 22, 12, 18).setFaction(this.Const.Faction.Undead);
    this.spawnEntity("scripts/entity/tactical/enemies/ghoul", 20, 22, 12, 18).assignRandomEquipment();
    this.spawnEntity("scripts/entity/tactical/enemies/ghoul", 20, 22, 12, 18).setFaction(this.Const.Faction.Undead);
    this.spawnEntity("scripts/entity/tactical/enemies/ghoul", 20, 22, 12, 18).assignRandomEquipment();
    this.spawnEntity("scripts/entity/tactical/enemies/ghoul", 21, 22, 16, 20).setFaction(this.Const.Faction.Undead);
    this.spawnEntity("scripts/entity/tactical/enemies/ghoul", 21, 22, 16, 20).assignRandomEquipment();
    this.spawnEntity("scripts/entity/tactical/enemies/ghoul", 7, 10, 12, 18).setFaction(this.Const.Faction.Undead);
    this.spawnEntity("scripts/entity/tactical/enemies/ghoul", 7, 10, 12, 18).assignRandomEquipment();
    this.spawnEntity("scripts/entity/tactical/enemies/ghoul", 7, 10, 12, 18).setFaction(this.Const.Faction.Undead);
    this.spawnEntity("scripts/entity/tactical/enemies/ghoul", 7, 10, 12, 18).assignRandomEquipment();
    this.spawnEntity("scripts/entity/tactical/enemies/ghoul", 7, 10, 12, 18).setFaction(this.Const.Faction.Undead);
    this.spawnEntity("scripts/entity/tactical/enemies/ghoul", 7, 10, 12, 18).assignRandomEquipment();
    ...
    this.spawnEntity("scripts/entity/tactical/enemies/ghoul", 7, 10, 12, 18).setFaction(this.Const.Faction.Undead);
    this.spawnEntity("scripts/entity/tactical/enemies/ghoul", 7, 10, 12, 18).assignRandomEquipment();
    this.spawnEntity("scripts/entity/tactical/enemies/ghoul", 13, 17, 21, 23).setFaction(this.Const.Faction.Undead);
    this.spawnEntity("scripts/entity/tactical/enemies/ghoul", 13, 17, 21, 23).assignRandomEquipment();
    this.spawnEntity("scripts/entity/tactical/enemies/ghoul", 13, 17, 21, 23).setFaction(this.Const.Faction.Undead);
    this.spawnEntity("scripts/entity/tactical/enemies/ghoul", 13, 17, 21, 23).assignRandomEquipment();
    this.spawnEntity("scripts/entity/tactical/enemies/ghoul", 13, 17, 21, 23).setFaction(this.Const.Faction.Undead);
    this.spawnEntity("scripts/entity/tactical/enemies/ghoul", 13, 17, 21, 23).assignRandomEquipment();
